...
inline void put_str(std::vector<uint8_t>& buf, uint8_t field_num, const std::string& str) {
    ...
    static RpcResponse decode(const std::vector<uint8_t>& buf) {
        ...
        while (offset < buf.size()) {
            ...
            if (kind == KIND_INT) {
                ...
                switch (field_num) {
                    case 1: resp.status = val; break;
                    case 2: resp.serial = val; break;
                    case 3: resp.handle = val; break;
                    case 5: resp.size = val; break;
                    case 6: resp.is_dir = val; break;
                }
                ...
                switch (field_num) {
                    case 1: resp.message = s; break;
                    case 4: resp.data = s; break;
                }
